...
{
    const string BROKER_NAME = "e-shop-on-container_event_bus";
    ...
    public void Publish(IntegrationEvent @event)
    {
        ...
        //channel.ExchangeBind("ScoreCardPublisher", BROKER_NAME, eventName);
    ...
    private IModel CreateConsumerChannel()
    {
        ...
        //channel.QueueBind(_queueName, BROKER_NAME, "ScoreCardCalculationIntegrationEvent");
